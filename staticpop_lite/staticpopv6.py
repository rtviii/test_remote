...
initial_landscape = [1,1,1,1] if SHIFTING_FITNESS_PEAK == 1 else [1,-1,1,-1]
...
for it in range(itern):
    if it > itern-int(5e6) and not(it%(DUMP_STATE_EVERY)):
        u.dump_state(it)
