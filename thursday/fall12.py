...
MUTATION_RATE_ALLELE         = 0.00001 if args.almrate is None else float(args.almrate)
MUTATION_RATE_CONTRIB_CHANGE = 0.00001 if args.gpmrate is None else float(args.gpmrate)
